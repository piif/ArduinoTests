...
void loop() {
	...
	if (status == MI_OK) {
		Serial.println("MFRC522_Request OK");
	} else {
		Serial.println("MFRC522_Request Failed");
		return;
	}
	...
	if (status == MI_OK) {
		...
		Serial.println("MFRC522_Anticoll Failed");
		return;
	}
	...
	if (RC_size != 0) {
		Serial.print("MFRC522_SelectTag ");Serial.println(RC_size);
	} else {
		Serial.println("MFRC522_SelectTag Failed");
		return;
	}
...
//		if (status == MI_OK) {
//			Serial.println("MFRC522_Write OK");
//		}
//	}
